...
const events = [
  ...
  },
  {
    ...
    date: 'Nov 14, 2025',
    description: 'Hands-on session for developers on DAO contract architecture.',
    link: '#',
  },
  {
    title: 'Community Onboarding Session',
    date: 'Nov 21, 2025',
    description: 'Live walkthrough for new members to explore DAO tools, governance, and opportunities.',
    link: '#',
  },
  {
    title: 'Tokenomics Deep Dive',
    date: 'Nov 28, 2025',
    description: 'Expert-led webinar unpacking DAO token distribution, staking models, and incentives.',
    link: '#',
  },
  {
    title: 'Quarterly DAO Town Hall',
    date: 'Dec 12, 2025',
    description: 'Leadership team shares key updates, roadmap progress, and answers community questions.',
    link: '#',
  },
];
      ...
      >
        {events.map((event, idx) => (
          ...
          >
            ...
            {/* Title */}
            <Typography sx={{ fontWeight: 600, fontSize: 18 }}>{event.title}</Typography>
