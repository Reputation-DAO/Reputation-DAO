...
export function DashboardSidebar({ userRole, userName, userPrincipal, onDisconnect }: SidebarProps) {
  ...
  return (
    <motion.div
      className="fixed inset-y-0 left-0 z-50 bg-white dark:bg-slate-900 border-r
                 border-slate-200/60 dark:border-slate-800/60 overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        {/* Scrollable middle area (no visible scrollbar) */}
        ...
        {/* Footer / User Section (non-scrolling) */}
