...
import { makeFactoriaWithInternetIdentity, getFactoriaCanisterId } from "@/lib/canisters";
import type {
...
const OrgSelectorPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const connect = async () => {
      ...
      try {
        const actor = await makeFactoriaWithInternetIdentity({
      ...
      <div className="relative min-h-screen bg-background text-foreground">
        ...
        <div className="flex min-h-screen flex-col items-center justify-center px-6">
          <Card className="max-w-lg border border-border bg-card p-10 text-center shadow-lg">
            ...
            <h2 className="mt-6 text-2xl font-semibold text-foreground">Connect Internet Identity</h2>
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              <p className="text-[11px] text-muted-foreground/70">
                Click the login button above to authenticate with Internet Identity.
              </p>
            </div>
          </Card>
        </div>
