...
import { idlFactory } from './factoria.did.js';
export { idlFactory } from './factoria.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FACTORIA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./factoria.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the factoria canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./factoria.did.js")._SERVICE>}
 */
export const factoria = createActor(canisterId);
