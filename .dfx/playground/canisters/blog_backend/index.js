...
export const canisterId = process.env.CANISTER_ID_BLOG_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./blog_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the blog_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./blog_backend.did.js")._SERVICE>}
 */
export const blog_backend = createActor(canisterId);
