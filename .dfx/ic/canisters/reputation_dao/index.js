...
import { idlFactory } from './reputation_dao.did.js';
export { idlFactory } from './reputation_dao.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REPUTATION_DAO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./reputation_dao.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the reputation_dao canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./reputation_dao.did.js")._SERVICE>}
 */
export const reputation_dao = createActor(canisterId);
